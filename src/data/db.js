...
const ALTER_COLS = [
  ...
  ['stock_score','sw_l1','TEXT'],
  ['stock_score','market_pct','REAL'],
  ['stock_score','rank_num','INTEGER'],
  ['stock_score','np_mom','REAL'],
  ['stock_score','pb','REAL'],
  ['stock_score','mktcap_yi','REAL'],
  ['stock_score','volatility_20d','REAL'],
  ['stock_score','ret_20d','REAL'],
  ['stock_score','ret_60d','REAL'],
